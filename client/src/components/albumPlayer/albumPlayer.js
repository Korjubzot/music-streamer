...
function AlbumPlayer() {
  ...
  if (error) {
    ...
    return (
      <>
        <div className="flex flex-col px-4 justify-center items center bg-gray-100">
          <h1 className="text-gray-600 text-4xl mt-2 ">{albumsData.title}</h1>
          ...
          <img
            className="max-w-lg max-h-lg my-4 rounded-lg shadow-md"
            src={img}
            alt="album art"
          />
          <Player />
